...
views = Blueprint("views", __name__) # подраздел общего сайта в котором описаны элементы сайта связанные с основной логикой
...
def home(): #
    ...
    return render_template('home.html', user=current_user, experts = experts) #пользователь перешёл на корневую страницу сайта, то ему нужно отобразить файл home.html, в который будет вписана информация о экспертах
